...
set :application, "fixtures"

set :repository,  "git@github.com:Karunakar/fixtures.git"
...
role :web,      "ec2-184-73-121-70.compute-1.amazonaws.com"
role :app,      "ec2-184-73-121-70.compute-1.amazonaws.com"
role :db,       "ec2-184-73-121-70.compute-1.amazonaws.com", :primary => true
